...
let memoizedFetch = function(element){
    ...
    if (memoizedData[element]){
        ...
        .catch(err => {return ("Unable to fetch " + element + " " + err)});
    }
...
memoizedFetch("https://www.google.com").then(response=> console.log(response))

memoizedFetchASync("https://www.google.com").then(response => console.log(response))
